...
public class SettingsFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        ignore_system.setOnPreferenceClickListener(preference -> {
        ...
        ignore_unknown.setOnPreferenceClickListener(preference -> {
            InstalledApp.executeQuery("UPDATE installed_app SET _isignored = 1 WHERE " +
        ...
        ignore_xposed.setOnPreferenceClickListener(preference -> {
            InstalledApp.executeQuery("UPDATE installed_app SET _isignored = 1 WHERE " +
        ...
        proxy_type.setOnPreferenceChangeListener((preference, newValue) -> {
            render_proxy_type_preference(newValue.toString());
            return true;
        });
        proxy_address.setOnPreferenceChangeListener((preference, newValue) -> {
        ...
        if (downloaded.size() == 0) {
            ...
            clean_apks.setOnPreferenceClickListener(preference -> {
        ...
        refresh_apps.setOnPreferenceClickListener(preference -> {

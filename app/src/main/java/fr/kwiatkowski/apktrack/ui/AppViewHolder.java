...
public class AppViewHolder extends RecyclerView.ViewHolder
    ...
    AppViewHolder(View v) {
        super(v);
        _app_name = v.findViewById(R.id.app_name);
        _app_version = v.findViewById(R.id.app_version);
        _app_icon = v.findViewById(R.id.app_icon);
        _check_date = v.findViewById(R.id.last_check);
        _action_icon = v.findViewById(R.id.action_icon);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            v.setOnTouchListener((v1, event) -> {
                v1.findViewById(R.id.list_item)
                        .getBackground()
    ...
    private void _set_action_icon(final InstalledApp app, final Context ctx) {
        if (app.is_currently_checking()) // Show the spinner.
        {
            ...
            if (app.get_download_url() != null) // The app may be ready to be downloaded or downloaded.
            {
                ...
                _action_icon.setOnClickListener(v -> {
            ...
            } else // Show the search icon
            {
                ...
                _action_icon.setOnClickListener(v -> _open_search_page(ctx, app));
            }
